...
class AdgroupsController extends AdminController {
	 ...
	 *
	 * @var \Idmkr\Adwords\Repositories\Adgroup\AdgroupRepository
	 */
	protected $adgroups;
	 ...
	 * Constructor.
	 *
	 * @param  \Idmkr\Adwords\Repositories\Adgroup\AdgroupRepository  $adgroups
	 * @return void
	 */
	public function __construct(AdgroupRepository $adgroups)
	{
		parent::__construct();
