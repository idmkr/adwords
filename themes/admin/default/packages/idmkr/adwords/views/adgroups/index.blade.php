...
@section('title')
@parent
{{ trans('idmkr/adwords::adgroups/common.title') }}
@stop
...
{{ Asset::queue('index', 'idmkr/adwords::adgroups/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('idmkr/adwords::adgroups/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.idmkr.adwords.adgroups.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="adgroup" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="adgroup" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="adgroup" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="adgroup" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="adgroup"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.idmkr.adwords.adgroups.grid') }}" data-grid="adgroup">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('idmkr/adwords::adgroups/model.general.id') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('idmkr/adwords::adgroups/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="adgroup"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('idmkr/adwords::adgroups/grid/index/results')
	@include('idmkr/adwords::adgroups/grid/index/pagination')
	@include('idmkr/adwords::adgroups/grid/index/filters')
	@include('idmkr/adwords::adgroups/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('idmkr/adwords::adgroups/help')
@endif
