...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'generation');

		$('.daterangepicker_end_input').attr('data-grid', 'generation');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('generation', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
