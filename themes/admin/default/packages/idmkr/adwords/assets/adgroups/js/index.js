...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'adgroup');

		$('.daterangepicker_end_input').attr('data-grid', 'adgroup');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('adgroup', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
