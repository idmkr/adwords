...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'generationfeeditemadgroup');

		$('.daterangepicker_end_input').attr('data-grid', 'generationfeeditemadgroup');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('generationfeeditemadgroup', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
