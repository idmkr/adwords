...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'campaigns');

		$('.daterangepicker_end_input').attr('data-grid', 'campaigns');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('campaigns', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
